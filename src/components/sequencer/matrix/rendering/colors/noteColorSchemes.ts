// src/components/sequencer/matrix/rendering/colors/noteColorSchemes.ts
...
import { SCRIABIN_COLOR_MAP } from '@/components/sequencer/matrix/rendering/colors/constants/pitchColorMap.js';
